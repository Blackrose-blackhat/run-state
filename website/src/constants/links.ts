...
export const LINKS = {
  ...
  DOWNLOADS: {
    APPIMAGE: `${REPO_PORTWATCH}/releases/download/v0.1.0/PortWatch_0.1.0_amd64.AppImage`,
    DEBIAN: `${REPO_PORTWATCH}/releases/download/v0.1.0/PortWatch_0.1.0_amd64.deb`,
    RPM: `${REPO_PORTWATCH}/releases/download/RPM/PortWatch-0.1.0-1.x86_64.rpm`,
  },
// https://github.com/Blackrose-blackhat/run-state/releases/download/Download/PortWatch_0.1.0_amd64.deb
  ...
  CURL: {
    DEBIAN: `curl -L -o portwatch.deb ${REPO_PORTWATCH}/releases/download/v0.1.0/PortWatch_0.1.0_amd64.deb`,
    APPIMAGE: `curl -L -o portwatch.AppImage ${REPO_PORTWATCH}/releases/download/v0.1.0/PortWatch_0.1.0_amd64.AppImage`,
